...
class PythonDataScienceTutorial2Handler(Resource):
    def get(self):
        headers = {'Content-Type': 'text/html'}
        return make_response(render_template('python-data-science-tutorial-2.html'), 200, headers)


class PythonDataScienceTutorial3Handler(Resource):
    def get(self):
        headers = {'Content-Type': 'text/html'}
